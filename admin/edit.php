            ...
            <form action="" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <button type="button" onclick="document.getElementById('file-input').click();"
                        class="w-full bg-gray-800 hover:bg-black text-white font-bold py-3 rounded-lg uppercase text-xs tracking-widest cursor-pointer">📷
                        Nieuwe Foto Uploaden</button>
                </div>
                ...
                <div class="md:col-span-2 flex justify-end gap-3 pt-6 border-t mt-4">
                    ...
                    <button type="submit"
                        class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-10 rounded-md shadow-sm transition cursor-pointer">Wijzigingen
                        Opslaan</button>
                </div>
            </form>
        </div>
