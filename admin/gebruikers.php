...
<body class="bg-gray-100 font-sans">
        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="index.php"
                        class="text-gray-300 hover:text-white hover:bg-gray-800 px-3 py-2 rounded-md text-sm font-medium transition duration-200 flex items-center gap-2">
                    ...
                    <a href="logout.php"
                        class="text-red-400 hover:text-red-300 hover:bg-red-900/20 px-3 py-2 rounded-md text-sm font-medium transition duration-200">
                        Uitloggen
                    </a>
                </div>
            </div>
                ...
                <tbody class="text-gray-700">
                    <?php foreach ($users as $u): ?>
                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <span
                                    class="px-2 py-1 rounded text-xs font-bold <?= $u['rol'] === 'owner' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700' ?>">
                                    <?= strtoupper($u['rol']) ?>
                                </span>
                            </td>
    ...
    <script>
        function openDeleteUserModal(id) {
            document.getElementById('confirmDeleteUserBtn').href = 'delete_user.php?id=' + id;
