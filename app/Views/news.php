...
<main class="flex-1">
        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <article style="border-top: 4px solid #ff40b4; padding-top: 1.5rem;">
                    ...
                    <p style="font-size: 0.95rem; color: #333; line-height: 1.7;">More information to follow. Stay tuned for updates on upcoming expositions and events.</p>
                </article>
                ...
                <article style="border-top: 4px solid #ff40b4; padding-top: 1.5rem;">
                    ...
                    <p style="font-size: 0.95rem; color: #333; line-height: 1.7;">Leather bags and wearable objects created for the Magnum Show — a film production by Fourcreating.</p>
                    <a href="/portfolio" style="display: inline-block; margin-top: 1rem; font-family: 'Bebas Neue', sans-serif; color: #ff40b4; font-size: 0.9rem; letter-spacing: 0.1em;">View in Portfolio →</a>
                </article>
                ...
                <article style="border-top: 4px solid #ff40b4; padding-top: 1.5rem;">
                    ...
                    <p style="font-size: 0.95rem; color: #333; line-height: 1.7;">New collections and commissioned objects currently in development. More to be shared soon.</p>
                </article>
    ...
    <section style="background-color: #000; padding: 4rem 2rem; text-align: center;">
        <div class="max-w-3xl mx-auto">
            ...
            <a href="/contact" class="inline-block text-black text-xl px-10 py-4 transition-all duration-200"
