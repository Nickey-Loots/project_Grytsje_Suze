...
<main class="flex-1">
    ...
    <div class="flex justify-center py-8" style="background-color: #000;">
        <a href="/portfolio" class="text-white text-2xl px-16 py-4 inline-block transition-all duration-200 shadow-lg"
    ...
    <section style="background-color: #fff; padding: 5rem 2rem;">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mt-8">
                <a href="/about" class="text-white text-xl px-10 py-4 inline-block transition-all duration-200"
    ...
    <section style="background-color: #000; padding: 5rem 2rem;">
        <div class="max-w-4xl mx-auto">
            ...
            <a href="/news" class="inline-block text-black text-xl px-10 py-4 transition-all duration-200"
               style="background-color: #ff40b4; font-family: 'Bebas Neue', sans-serif;"
               onmouseover="this.style.backgroundColor='#e0359e'"
    ...
    <section style="background-color: #fff; padding: 5rem 2rem;">
        <div class="max-w-3xl mx-auto">
            ...
            <a href="/contact" class="inline-block text-white text-xl px-10 py-4 transition-all duration-200"
               style="background-color: #000; font-family: 'Bebas Neue', sans-serif;"
               onmouseover="this.style.backgroundColor='#ff40b4'"
