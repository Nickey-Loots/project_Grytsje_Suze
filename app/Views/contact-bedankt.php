...
<main class="flex-1 flex items-center justify-center" style="background-color: #fff; padding: 6rem 2rem;">
    <div class="text-center max-w-2xl mx-auto">
        ...
        <p style="font-size: 1.1rem; color: #333; line-height: 1.8; margin-bottom: 1rem;">Your request has been received.</p>
        <p style="font-size: 1rem; color: #777; line-height: 1.8; margin-bottom: 3rem;">Each inquiry is reviewed with care, and I'll come back to you as soon as possible.</p>
        <a href="/" class="inline-block text-white text-2xl px-12 py-5 transition-all duration-200"
