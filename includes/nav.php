...
<div class="relative" style="padding-top: 50px; margin-top: 5px;">
    ...
    <header style="background-color: #000; height: 75px; position: relative; z-index: 10;" class="flex items-center justify-between px-4 md:px-10">
        ...
        <nav class="hidden md:flex items-center gap-6 lg:gap-10" style="font-family: 'Bebas Neue', sans-serif; font-size: 1.1rem;">
            ...
            <?= navLink('portfolio.php', 'Work', $currentPage) ?>
            <?= navLink('collaborations.php', 'Collaborations', $currentPage) ?>
        </nav>
        ...
        <nav class="hidden md:flex items-center gap-6 lg:gap-10" style="font-family: 'Bebas Neue', sans-serif; font-size: 1.1rem;">
            <?= navLink('commissions.php', 'Commissions', $currentPage) ?>
            <?= navLink('news.php', 'News', $currentPage) ?>
            <?= navLink('contact.php', 'Contact', $currentPage) ?>
        </nav>

        <!-- Mobile: hamburger (right side, before logo) -->
        <button
    ...
    <div id="mob-menu" class="hidden" style="background-color: #111; padding: 1.5rem 2rem; position: relative; z-index: 15;">
        <nav class="flex flex-col gap-5" style="font-family: 'Bebas Neue', sans-serif;">
            <a href="about.php" class="text-white text-2xl tracking-widest hover:text-pink-400 transition-colors">About</a>
            <a href="portfolio.php" class="text-white text-2xl tracking-widest hover:text-pink-400 transition-colors">Work</a>
            <a href="collaborations.php" class="text-white text-2xl tracking-widest hover:text-pink-400 transition-colors">Collaborations</a>
            <a href="commissions.php" class="text-white text-2xl tracking-widest hover:text-pink-400 transition-colors">Commissions</a>
            <a href="news.php" class="text-white text-2xl tracking-widest hover:text-pink-400 transition-colors">News</a>
            <a href="contact.php" class="text-white text-2xl tracking-widest hover:text-pink-400 transition-colors">Contact</a>
        </nav>
    </div>
