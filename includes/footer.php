<footer class="border-t-4 border-black px-4 md:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
    ...
    <nav class="flex flex-wrap justify-center gap-4 md:gap-6 text-xs tracking-widest text-gray-600" style="font-family: 'Bebas Neue', sans-serif;">
        ...
        <a href="collaborations.php" class="hover:text-pink-500 transition-colors">Collaborations</a>
        <a href="commissions.php" class="hover:text-pink-500 transition-colors">Commissions</a>
        <a href="news.php" class="hover:text-pink-500 transition-colors">News</a>
        <a href="contact.php" class="hover:text-pink-500 transition-colors">Contact</a>
    </nav>
