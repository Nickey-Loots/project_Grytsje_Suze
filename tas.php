...
$isDark = $textColorClass === 'text-white';
$overlayRgb = $isDark ? '255,255,255' : '0,0,0';

$galerij = !empty($tas['galerij']) ? json_decode($tas['galerij'], true) : [];
?>
<!DOCTYPE html>
<html lang="nl">
                ...
                <aside id="palette" class="overflow-hidden! flex! flex-col! p-5! pl-8!">
                    ...
                    <div class="toolbar shrink-0! mt-3! pt-3! border-t!">
                        <div class="button-row">
                            <button class="action-btn color-[currentColor]!" id="rotateBtn">
                                Toggle Auto Rotate
                            </button>
                        </div>
                    </div>
