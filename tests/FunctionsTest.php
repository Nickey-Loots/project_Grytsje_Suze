...
class FunctionsTest extends TestCase
{
    ...
    {
        return createTas($this->pdo, $naam, 'Een beschrijving', 'uploads/foto.jpg', '#ff40b4');
    }
    ...
    {
        return createAdmin($this->pdo, $email, $wachtwoord);
    }
    ...
    public function it_stores_all_bag_fields_correctly_when_created(): void
    {
        ...
        $id = createTas($this->pdo, 'Rode Tas', 'Mooie tas', 'uploads/rood.jpg', '#ff0000', '', '#ffffff', '#000000');
        $tas = getTasById($this->pdo, $id);
    ...
    public function it_returns_null_when_a_bag_does_not_exist(): void
    {
        ...
        $result = getTasById($this->pdo, 99999);
    ...
    {
        // Voegt drie tassen toe en controleert of getAllTassen() ook daadwerkelijk een count van exact 3 rijen teruggeeft
        $this->maakTestTas('Tas A');
        $this->maakTestTas('Tas B');
        $this->maakTestTas('Tas C');

        $tassen = getAllTassen($this->pdo);
    ...
    public function it_updates_the_bag_name_correctly(): void
    {
        ...
        updateTas($this->pdo, $id, 'Nieuwe Naam', 'Beschrijving', 'uploads/foto.jpg', '#000000');
    ...
    public function it_returns_false_when_updating_a_bag_that_does_not_exist(): void
    {
        ...
        $result = updateTas($this->pdo, 99999, 'Naam', 'Beschrijving', 'uploads/foto.jpg', '#000000');
    ...
    public function it_deletes_a_bag_and_returns_the_image_path(): void
    {
        ...
        $id = createTas($this->pdo, 'Weg Tas', 'bye', 'uploads/weg.jpg', '#000000');
        $pad = deleteTas($this->pdo, $id);

        $this->assertSame('uploads/weg.jpg', $pad);
        $this->assertNull(getTasById($this->pdo, $id));
    }
    ...
    public function it_returns_null_when_deleting_a_bag_that_does_not_exist(): void
    {
        ...
        $result = deleteTas($this->pdo, 99999);
        $this->assertNull($result);
    }
    ...
    public function it_returns_the_user_when_login_credentials_are_correct(): void
    {
        ...
        $user = loginUser($this->pdo, 'login@test.nl', 'wachtwoord123');
    ...
    public function it_returns_null_when_login_credentials_are_incorrect(): void
    {
        ...
        $result = loginUser($this->pdo, 'login@test.nl', 'fout');
    ...
    public function it_deletes_an_admin_but_protects_the_owner(): void
    {
        ...
        $this->assertTrue(deleteUser($this->pdo, $adminId));
        $this->assertFalse(deleteUser($this->pdo, $ownerId));
    }
    ...
    public function it_returns_white_text_on_dark_background_colors(): void
    {
        ...
        $this->assertSame('text-white', getContrastColor('#000000'));
        $this->assertSame('text-white', getContrastColor('#1a1a2e'));
        $this->assertSame('text-white', getContrastColor('#3b0764'));
    }
    ...
    public function it_returns_black_text_on_light_background_colors(): void
    {
        ...
        $this->assertSame('text-black', getContrastColor('#ffffff'));
        $this->assertSame('text-black', getContrastColor('#f0f0f0'));
        $this->assertSame('text-black', getContrastColor('#ffff00'));
    }
